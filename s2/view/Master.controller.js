jQuery.sap.require("sap.ui.sample.poa.util.formatter");

sap.ui.controller("sap.ui.sample.poa.view.Master", {
	...
	_updateList: function(){
		...
		// update info toolbar (For touch device)
    ...
    /* The "swipeContent" control gets disabled for non-touch devices.
     * So, this function only take effect on touch device
     */
	handleListItemApprove: function(evt){
		...
		var busyDialog = new sap.m.BusyDialog({
			...
			close: function(){
				...
				/*
				 * This operation shows how to process oData on the client
				 * */
