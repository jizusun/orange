jQuery.sap.declare("sap.ui.sample.poa.Component");

sap.ui.core.UIComponent.extend("sap.ui.sample.poa.Component", {

	metadata : {
		routing : {
			config : {
				viewType : "XML",
				viewPath : "sap.ui.sample.poa.view",
	...
	init : function () {
		...
		jQuery.sap.require("sap.ui.sample.poa.MyRouter");
		jQuery.sap.require("sap.ui.sample.poa.model.Config");
		jQuery.sap.require("sap.ui.sample.poa.util.objectSearch");
		// 2. call overwritten init (calls createContent)
		sap.ui.core.UIComponent.prototype.init.apply(this, arguments);
		// 3a. monkey patch the router
		var oRouter = this.getRouter();
		oRouter.myNavBack = sap.ui.sample.poa.MyRouter.myNavBack;
		oRouter.myNavToWithoutHash = sap.ui.sample.poa.MyRouter.myNavToWithoutHash;
	...
	createContent : function () {
		...
		var oModel;
		if (!sap.ui.sample.poa.model.Config.isMock) {
