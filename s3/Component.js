jQuery.sap.declare("sap.ui.sample.shoppingcart.Component");

sap.ui.core.UIComponent.extend("sap.ui.sample.shoppingcart.Component", {
	...
	init : function () {
		...
		jQuery.sap.require("sap.ui.sample.shoppingcart.MyRouter");
		...
		jQuery.extend(this._router, sap.ui.sample.shoppingcart.MyRouter);
